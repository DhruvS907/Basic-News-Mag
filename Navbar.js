...
const Navbar = ({isDarkMode, setCategory}) => {
  return(
    <nav className="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme={isDarkMode}>
    <div className="container-fluid">
      <a className="navbar-brand" href="#"><span classNameName="badge bg-light text-black fs-4">NewsMag</span></a>
